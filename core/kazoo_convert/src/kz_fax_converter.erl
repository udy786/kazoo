...
%%------------------------------------------------------------------------------
%% @doc This function converts the data or file specified in `Content' from the `To' mime-type to the
%% `From' mime-type.
%%
...
%%------------------------------------------------------------------------------
%% @doc This function collects the fax related metadata from a file
%%
%% Properties returned:
%% <ul>
